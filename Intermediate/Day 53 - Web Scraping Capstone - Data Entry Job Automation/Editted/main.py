...
# Substitute in your own env file
chrome_driver_path = os.environ["CHROME_DRIVER_PATH"]
driver = webdriver.Chrome(executable_path=chrome_driver_path)

for n in range(len(all_links)):
    # Substitute your own Google Form URL here - or can make a new line to create a variable for your sheets
    driver.get("https://docs.google.com/spreadsheets/d/1DhZ3h2iF7cQjGnpMGhAjxyPd_ErnadAvBVLj0bqplmI/edit?usp=sharing")
